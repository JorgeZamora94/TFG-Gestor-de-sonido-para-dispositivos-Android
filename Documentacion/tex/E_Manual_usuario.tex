...
\imagen{menu}{Imagen que muestra el menú de la aplicación.}
...
\imagen{permisosubicacion}{Imagen que muestra el mensaje en el cual aceptaremos o denegaremos los permisos para permitir que la aplicación pueda acceder a la ubicación del dispositivo.}

\imagen{permisoscalendario}{Imagen que muestra el mensaje en el cual aceptaremos o denegaremos los permisos para permitir que la aplicación acceda al calendario de nuestro dispositivo.}
...
\imagen{principal}{Imagen que muestra la pantalla principal de la aplicación.}
...
\imagen{perfildesonido}{Imagen que muestra la pantalla para la creación de perfiles de sonido.}
...
\imagen{eventoperiodico}{Imagen que muestra la pantalla para la creación de eventos periódicos.}
...
\imagen{eventomanual}{Imagen que muestra la pantalla para la creación de los eventos manuales.}
...
\imagen{eventogps}{Imagen que nos muestra la pantalla para la creación de los eventos de GPS.}
...
\imagen{eventowifi}{Imagen que nos muestra la pantalla para la creación de eventos wifi.}
...
\imagen{eventocalendario}{Imagen que muestra la pantalla para la creación de los eventos de calendario.}
...
\imagen{configuracionapp}{Imagen en la que veremos la pantalla que nos permite el activar o desactivar un tipo de evento en concreto}
...
\imagen{listadoeventos}{Imagen que muestra la pantalla en la cual podremos ver los eventos que están creados y eliminarlos de la aplicación.}
...
\imagen{ayudamanual}{Imagen que muestra la pantalla para la creación de eventos manuales.}

\imagen{ayudaperiodico}{Imagen que muestra la pantalla para la creación de eventos periódicos.}

\imagen{ayudawifi}{Imagen que muestra la pantalla para la creación de eventos wifi.}

\imagen{ayudacalendario}{Imagen que muestra la pantalla para la creación de eventos de calendario.}

\imagen{ayudagps}{Imagen que muestra la pantalla para la creación de eventos gps.}

\imagen{ayudaperfiles}{Imagen que muestra la pantalla para la creación de perfiles de sonido.}

\imagen{contacto}{Imagen que muestra la pantalla para el acceso a las diferentes redes sociales y poder establecer contacto para obtener soporte de la aplicación.}
